...
public class OffersService {
	...
	public List<Offer> getOffer(int id) {
		return offersDao.getOffers(id);
		
	}

	public void save(Buytkts buytkt) {
		offersDao.save(buytkt);
		
	}

	public List<Buytkts> getCurrentevent(String username) {
		
		return offersDao.getevents(username);
	}
