package test.com.caveofprogramming.spring.web.test.tests;
...
public class OfferDaoTests {
	...
	private User user1 = new User("johnwpurcell", "John Purcell", "hellothere",
			"john@caveofprogramming.com", true, "ROLE_USER",null);
	private User user2 = new User("richardhannay", "Richard Hannay",
			"the39steps", "richard@caveofprogramming.com", true, "ROLE_ADMIN",null);
	private User user3 = new User("suetheviolinist", "Sue Black",
			"iloveviolins", "sue@caveofprogramming.com", true, "ROLE_USER",null);
	private User user4 = new User("rogerblake", "Rog Blake", "liberator",
			"rog@caveofprogramming.com", false, "user",null);

	private Offer offer1 = new Offer("Title", "Type","Venue","12-12-2014 22:22:22",20,50,user1);
	private Offer offer2 = new Offer("This is another test offer.", null, null, null, 0, 0,user2);
	private Offer offer3 = new Offer("Title", "Type","Venue","12-12-2014 22:22:22",20,50,user3);
	private Offer offer4 = new Offer("Title", "Type","Venue","12-12-2014 22:22:22",20,50,user4);
	//private Offer offer5 = new Offer("Title", "Type","Venue","12-12-2014 22:22:22",20,50);
	//private Offer offer6 = new Offer(user2, "Title", "Type","Venue","12-12-2014 22:22:22",20,50);
	//private Offer offer7 = new Offer(user3, "Title", "Type","Venue","12-12-2014 22:22:22",20,50);
